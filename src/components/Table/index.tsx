                ...
                return (
                  <>
                    <TableRow
                      hover
                      onClick={(event) =>
                        handleClick(event, row.sku as unknown as number)
                      }
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <div className="flex flex-col items-center justify-center gap-y-0">
                          <ToggleSwitch
                            isDisabled={true}
                            isChecked={row.truln as unknown as boolean}
                          />
                          <ViewButton
                          ...
                          <Collapse in={open} timeout="auto" unmountOnExit>
                            <Box sx={{ margin: 1 }}>
                              ...
                              <p className="text-gray-500 max-w-full">
                                This section is dedicated to displaying item
                                descriptions and other relevant details for an
                                ongoing project. It serves as a placeholder to
                                showcase the intended content and layout, but
                                the project is still in progress and may undergo
